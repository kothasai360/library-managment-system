...
class login:
     ...
     def loginfn(self):
        ...
        if self.flag !=0:
            self.buttonlibrain = Button(self.frame,text='Librarian',bg='Orange',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.adminbutton2)
        else:
            self.buttonlibrain = Button(self.frame,text='librarian',bg='Orange',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.adminbutton)
	...
	# placing
        ...
        self.buttonlibrain.place(x=320,y=30,width=140,height=50)
